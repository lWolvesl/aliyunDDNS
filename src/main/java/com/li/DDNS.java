...
public class DDNS {
    ...
    public static void main(String[] args) throws IOException {
        InputStream in = ClassLoader.getSystemResourceAsStream("accessKey.properties");
        ...
        while (true) {
            ...
            // 主域名
            describeDomainRecordsRequest.setDomainName(properties.getProperty("domainName"));
            // 主机记录
            describeDomainRecordsRequest.setRRKeyWord(properties.getProperty("RRKeyWord"));
            // 解析记录类型
            ...
            if (domainRecords.size() != 0) {
                ...
                if (!currentHostIP.equals(recordsValue)) {
                    ...
                    // 主机记录
                    updateDomainRecordRequest.setRR(properties.getProperty("RRKeyWord"));
                    // 记录ID
            ...
            try {
                TimeUnit.HOURS.sleep(Long.parseLong(properties.getProperty("hour")));
